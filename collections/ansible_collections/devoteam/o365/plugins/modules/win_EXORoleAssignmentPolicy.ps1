...
$Roles                   = Get-AnsibleParam -obj $params -name "Roles" -type "list"
...
function Actions($data){
    ...
    if($newData["Ensure"] -eq "Absent"){
        $result.msg = "This role assignment policy has been revoved or don't exist"
    }else{
        $result.msg = "This role assignment policy policy has been created or already exist"
    }
