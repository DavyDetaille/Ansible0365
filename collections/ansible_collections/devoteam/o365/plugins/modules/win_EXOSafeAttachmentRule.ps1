...
$SafeAttachmentPolicy      = Get-AnsibleParam -obj $params -name "SafeAttachmentPolicy" -type "str"
...
function Actions($data){
    ...
    if($newData["Ensure"] -eq "Absent"){
        $result.msg = "This safe attachments is revoved or don't exist"
    }else{
        $result.msg = "This safe attachments is revoved or don't exist"
    }
