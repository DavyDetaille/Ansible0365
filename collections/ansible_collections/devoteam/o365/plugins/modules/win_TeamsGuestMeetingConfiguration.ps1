...
$ScreenSharingMode = Get-AnsibleParam -obj $params -name "ScreenSharingMode" -type "str" -validateset "Disabled", "EntireScreen", "SingleApplication"
...
function M365TenantConfig{
    ...
    Configuration M365TenantConfig{
        ...
        Node localhost{
            TeamsGuestMeetingConfiguration "data"{
