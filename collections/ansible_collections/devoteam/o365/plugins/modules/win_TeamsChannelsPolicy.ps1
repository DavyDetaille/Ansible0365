...
$AllowChannelSharingToExternalUser             = Get-AnsibleParam -obj $params -name "AllowChannelSharingToExternalUser" -type "bool"
$AllowOrgWideTeamCreation                      = Get-AnsibleParam -obj $params -name "AllowOrgWideTeamCreation" -type "bool"
$AllowPrivateTeamDiscovery                     = Get-AnsibleParam -obj $params -name "AllowPrivateTeamDiscovery" -type "bool"
$AllowPrivateChannelCreation                   = Get-AnsibleParam -obj $params -name "AllowPrivateChannelCreation" -type "bool"
$AllowSharedChannelCreation                    = Get-AnsibleParam -obj $params -name "AllowSharedChannelCreation" -type "bool"
$AllowUserToParticipateInExternalSharedChannel = Get-AnsibleParam -obj $params -name "AllowUserToParticipateInExternalSharedChannel" -type "bool"
...
$inputData = @{
    ...
    AllowChannelSharingToExternalUser             = $AllowChannelSharingToExternalUser
    AllowOrgWideTeamCreation                      = $AllowOrgWideTeamCreation
    AllowPrivateTeamDiscovery                     = $AllowPrivateTeamDiscovery
    AllowPrivateChannelCreation                   = $AllowPrivateChannelCreation
    AllowSharedChannelCreation                    = $AllowSharedChannelCreation
    AllowUserToParticipateInExternalSharedChannel = $AllowUserToParticipateInExternalSharedChannel
    Ensure                                        = $Ensure
} 
...
function Actions($data){
    ...
    if($newData["Ensure"] -eq "Absent"){
        $result.msg = "This teams channel is revoved or don't exist"
    }else{
        $result.msg = "This teams channel is created or alredy exist"
    }
