...
$Default                 = Get-AnsibleParam -obj $params -name "Default" -type "bool" # $True;
$Domains                 = Get-AnsibleParam -obj $params -name "Domains" -type "list" # @("Anonymous:CalendarSharingFreeBusyReviewer","*:CalendarSharingFreeBusySimple");
$Enabled                 = Get-AnsibleParam -obj $params -name "Enabled" -type "bool" # $True;
$Ensure                  = Get-AnsibleParam -obj $params -name "Ensure" -type "str" -validateset "Present", "Absent" -failifempty $true# "Present";
$Name                    = Get-AnsibleParam -obj $params -name "Name" -type "str" # "Default Sharing Policy";
