...
$PrimarySMTPAddress    = Get-AnsibleParam -obj $params -name "PrimarySMTPAddress" -type "str"
$Aliases               = Get-AnsibleParam -obj $params -name "Aliases" -type "str"
...
function Actions($data){
    ...
    if($newData["Ensure"] -eq "Absent"){
        $result.msg = "This shared mailbox is revoved or don't exist"
    }else{
        $result.msg = "This shared mailbox is created or alredy exist"
    }
