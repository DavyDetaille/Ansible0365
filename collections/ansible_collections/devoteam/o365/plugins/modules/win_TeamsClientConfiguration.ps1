...
$AllowBox                         = Get-AnsibleParam -obj $params -name "AllowBox" -type "bool"
$AllowDropBox                     = Get-AnsibleParam -obj $params -name "AllowDropBox" -type "bool"
$AllowEgnyte                      = Get-AnsibleParam -obj $params -name "AllowEgnyte" -type "bool"
$AllowEmailIntoChannel            = Get-AnsibleParam -obj $params -name "AllowEmailIntoChannel" -type "bool"
$AllowGoogleDrive                 = Get-AnsibleParam -obj $params -name "AllowGoogleDrive" -type "bool"
$AllowGuestUser                   = Get-AnsibleParam -obj $params -name "AllowGuestUser" -type "bool"
$AllowOrganizationTab             = Get-AnsibleParam -obj $params -name "AllowOrganizationTab" -type "bool"
$AllowResourceAccountSendMessage  = Get-AnsibleParam -obj $params -name "AllowResourceAccountSendMessage" -type "bool"
$AllowScopedPeopleSearchandAccess = Get-AnsibleParam -obj $params -name "AllowScopedPeopleSearchandAccess" -type "bool"
$AllowShareFile                   = Get-AnsibleParam -obj $params -name "AllowShareFile" -type "bool"
$AllowSkypeBusinessInterop        = Get-AnsibleParam -obj $params -name "AllowSkypeBusinessInterop" -type "bool"
$ContentPin                       = Get-AnsibleParam -obj $params -name "ContentPin" -type "str" -validateset "NotRequired", "RequiredOutsideScheduleMeeting", "AlwaysRequired"
$Identity                         = Get-AnsibleParam -obj $params -name "Identity" -type "str" -validateset "Global"
$ResourceAccountContentAccess     = Get-AnsibleParam -obj $params -name "ResourceAccountContentAccess" -type "str" -validateset "NoAccess", "PartialAccess", "FullAccess"
$RestrictedSenderList             = Get-AnsibleParam -obj $params -name "RestrictedSenderList" -type "list"
...
$inputData = @{
    ...
    AllowOrganizationTab             = $AllowOrganizationTab
    AllowResourceAccountSendMessage  = $AllowResourceAccountSendMessage
    AllowScopedPeopleSearchandAccess = $AllowScopedPeopleSearchandAccess
    AllowShareFile                   = $AllowShareFile
    AllowSkypeBusinessInterop        = $AllowSkypeBusinessInterop
    ContentPin                       = $ContentPin
    Identity                         = $Identity
    ResourceAccountContentAccess     = $ResourceAccountContentAccess
    RestrictedSenderList             = $RestrictedSenderList
} 
