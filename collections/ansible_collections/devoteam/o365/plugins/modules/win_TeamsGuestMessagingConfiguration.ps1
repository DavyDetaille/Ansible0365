...
$GiphyRatingType        = Get-AnsibleParam -obj $params -name "GiphyRatingType" -type "str" -validateset "Moderate", "Strict", "NoRestriction"
...
function M365TenantConfig{
    ...
    Configuration M365TenantConfig{
        ...
        Node localhost{
            TeamsGuestMessagingConfiguration "data"{
