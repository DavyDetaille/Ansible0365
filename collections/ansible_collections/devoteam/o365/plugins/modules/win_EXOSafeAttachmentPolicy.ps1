...
$Action                = Get-AnsibleParam -obj $params -name "Action" -type "str" -validateset "Block", "Replace", "Allow", "DynamicDelivery", $null
$ActionOnError         = Get-AnsibleParam -obj $params -name "ActionOnError" -type "bool"
$AdminDisplayName      = Get-AnsibleParam -obj $params -name "AdminDisplayName" -type "str"
$Enable                = Get-AnsibleParam -obj $params -name "Enable" -type "bool"
...
$Redirect              = Get-AnsibleParam -obj $params -name "Redirect" -type "bool"
$RedirectAddress       = Get-AnsibleParam -obj $params -name "RedirectAddress" -type "str"
