...
$AllowMemes                    = Get-AnsibleParam -obj $params -name "AllowMemes" -type "bool"
$AllowOwnerDeleteMessage       = Get-AnsibleParam -obj $params -name "AllowOwnerDeleteMessage" -type "bool"
$AllowUserEditMessage          = Get-AnsibleParam -obj $params -name "AllowUserEditMessage" -type "bool"
$AllowStickers                 = Get-AnsibleParam -obj $params -name "AllowStickers" -type "bool"
$AllowUrlPreviews              = Get-AnsibleParam -obj $params -name "AllowUrlPreviews" -type "bool"
$AllowUserChat                 = Get-AnsibleParam -obj $params -name "AllowUserChat" -type "bool"
$AllowUserDeleteMessage        = Get-AnsibleParam -obj $params -name "AllowUserDeleteMessage" -type "bool"
$AllowUserTranslation          = Get-AnsibleParam -obj $params -name "AllowUserTranslation" -type "bool"
$AllowImmersiveReader          = Get-AnsibleParam -obj $params -name "AllowImmersiveReader" -type "bool"
$AllowRemoveUser               = Get-AnsibleParam -obj $params -name "AllowRemoveUser" -type "bool"
$AllowPriorityMessages         = Get-AnsibleParam -obj $params -name "AllowPriorityMessages" -type "bool"
$Description                   = Get-AnsibleParam -obj $params -name "Description" -type "str"
$GiphyRatingType               = Get-AnsibleParam -obj $params -name "GiphyRatingType" -type "str" -validateset "STRICT", "MODERATE", "NORESTRICTION"
$ReadReceiptsEnabledType       = Get-AnsibleParam -obj $params -name "ReadReceiptsEnabledType" -type "str" -validateset "UserPreference", "Everyone", "None"
$ChannelsInChatListEnabledType = Get-AnsibleParam -obj $params -name "ChannelsInChatListEnabledType" -type "str" -validateset "DisabledUserOverride", "EnabledUserOverride"
$AudioMessageEnabledType       = Get-AnsibleParam -obj $params -name "AudioMessageEnabledType" -type "str" -validateset "ChatsAndChannels", "ChatsOnly", "Disabled"
$Tenant                        = Get-AnsibleParam -obj $params -name "Tenant" -type "str"
...
$inputData = @{
    ...
    AllowUserEditMessage          = $AllowUserEditMessage
    ...
    AllowImmersiveReader          = $AllowImmersiveReader
    AllowRemoveUser               = $AllowRemoveUser
    AllowPriorityMessages         = $AllowPriorityMessages
    Description                   = $Description
    GiphyRatingType               = $GiphyRatingType
    ReadReceiptsEnabledType       = $ReadReceiptsEnabledType
    ChannelsInChatListEnabledType = $ChannelsInChatListEnabledType
    AudioMessageEnabledType       = $AudioMessageEnabledType
    Tenant                        = $Tenant
    Ensure                        = $Ensure
} 
