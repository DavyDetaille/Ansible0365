...
$CustomNotificationText        = Get-AnsibleParam -obj $params -name "CustomNotificationText" -type "str"
$DeliverMessageAfterScan       = Get-AnsibleParam -obj $params -name "DeliverMessageAfterScan" -type "bool"
$DoNotAllowClickThrough        = Get-AnsibleParam -obj $params -name "DoNotAllowClickThrough" -type "bool"
$DoNotRewriteUrls              = Get-AnsibleParam -obj $params -name "DoNotRewriteUrls" -type "list" 
$DoNotTrackUserClicks          = Get-AnsibleParam -obj $params -name "DoNotTrackUserClicks" -type "bool"
$EnableForInternalSenders      = Get-AnsibleParam -obj $params -name "EnableForInternalSenders" -type "bool" 
$EnableOrganizationBranding    = Get-AnsibleParam -obj $params -name "EnableOrganizationBranding" -type "bool"
$EnableSafeLinksForTeams       = Get-AnsibleParam -obj $params -name "EnableSafeLinksForTeams" -type "bool"
...
$IsEnabled                     = Get-AnsibleParam -obj $params -name "IsEnabled" -type "bool"
$ScanUrls                      = Get-AnsibleParam -obj $params -name "ScanUrls" -type "bool"

$UseTranslatedNotificationText = Get-AnsibleParam -obj $params -name "UseTranslatedNotificationText" -type "bool"
...
$inputData = @{
    ...
    DoNotAllowClickThrough        = $DoNotAllowClickThrough
    DoNotRewriteUrls              = $DoNotRewriteUrls
    DoNotTrackUserClicks          = $DoNotTrackUserClicks
    ...
    UseTranslatedNotificationText = $UseTranslatedNotificationText
