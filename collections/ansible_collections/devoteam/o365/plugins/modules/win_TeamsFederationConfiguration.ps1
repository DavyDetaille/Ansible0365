...
$AllowFederatedUsers       = Get-AnsibleParam -obj $params -name "AllowFederatedUsers" -type "bool"
$AllowPublicUsers          = Get-AnsibleParam -obj $params -name "AllowPublicUsers" -type "bool"
$AllowTeamsConsumer        = Get-AnsibleParam -obj $params -name "AllowTeamsConsumer" -type "bool"
$AllowTeamsConsumerInbound = Get-AnsibleParam -obj $params -name "AllowTeamsConsumerInbound" -type "bool"
...
function M365TenantConfig{
    ...
    Configuration M365TenantConfig{
        ...
        Node localhost{
            TeamsFederationConfiguration "data"{
